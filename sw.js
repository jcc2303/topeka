...
this.addEventListener("install", function(e) {
  e.waitUntil(caches.create("core").then(function(core) {
    var resourceUrls = [
      ...
      "images/splash.svg",
      "templates/topeka-quiz-alpha-picker.html",
      "templates/topeka-quiz-fill-blank.html",
      "templates/topeka-quiz-fill-two-blanks.html",
      "templates/topeka-quiz-four-quarter.html",
      "templates/topeka-quiz-multi-select.html",
      "templates/topeka-quiz-picker.css",
      "templates/topeka-quiz-picker.html",
      "templates/topeka-quiz-single-select-item.html",
      "templates/topeka-quiz-single-select.html",
      "templates/topeka-quiz-toggle-translate.html",
      "templates/topeka-quiz-true-false.html",
      "theme.html",
      "topeka-app.css",
      "topeka-app.html",
      "topeka-categories.css",
      "topeka-categories.html",
      "topeka-category-front-page.html",
      "topeka-category-themes.css",
      "topeka-category.css",
      "topeka-category.html",
      "topeka-datasource.html",
      "topeka-leaderboard.html",
      "topeka-profile.html",
      "topeka-quiz-base.html",
      "topeka-quiz-score.html",
      "topeka-quiz-view.html",
      "topeka-quizzes.css",
      "topeka-quizzes.html",
      "topeka-results.css",
      "topeka-results.html",
      "topeka-status-bar.html",
      "topeka-user-score.css",
      "topeka-user-score.html",
      "icons/icon-196.png",
      "images/splash.svg",
      "index.html",
